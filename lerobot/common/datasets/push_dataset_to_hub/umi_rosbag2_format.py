...
"""Process UMI (Universal Manipulation Interface) data from a rs2 bag file"""
...
def load_from_raw(raw_dir: Path, videos_dir: Path, fps: int, video: bool, episodes: list[int] | None = None):
    """ This function takes a path to the ros2 bag files and returns a dictionary with the data """
...
def from_raw_to_lerobot_format( # This is the main function that gets called in push to hub
    raw_dir: Path,
    videos_dir: Path,
    fps: int | None = None,
    video: bool = True,
